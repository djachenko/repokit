...
echo "│     owner: $OWNER   repo: $REPO   workflow: languages/python/workflows/release.yml"
echo "│                                                                          │"
echo "│  4. Add Trusted Publisher on TestPyPI:                                  │"
echo "│     https://test.pypi.org/manage/account/publishing/                    │"
echo "│     owner: $OWNER   repo: $REPO   workflow: languages/python/workflows/integration.yml"
echo "│                                                                          │"
echo "└──────────────────────────────────────────────────────────────────────────┘"
